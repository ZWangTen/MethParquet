...
MethParquet::write_parquet_meth(data_path=methpath,format='csv',group_by='CHR',parquet_path = path)
```
...
mixed=ewas_meth_exposure(db_obj=mlist,m.null,select_sites = FALSE,select_chr = chr, out_position=c('CHR','MAPINFO','Gene'))
kable(head(mixed))
```
